...
def usage
  puts 'Usage: %s.rb <PREVHRI> <NEWREGIONINFO>' % NAME
  exit!
end
...
hole = HRegionInfo.new(htd, smaller.getEndKey(), Java::byte[0].new )
writeHri(Path.new(java.lang.String.new(ARGV[1])), hole)
